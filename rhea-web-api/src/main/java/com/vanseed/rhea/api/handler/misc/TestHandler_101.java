 ...
 */
@Component
@AHandler(protocol="0000", version = "1.0.1")
public class TestHandler_101 extends BaseHandler implements ITestHandler {
	...
	private MResponse echo( MRequestHeader header, Map params ) {
		...
		map.put("message", "hi, this is v1.0.1,"+(userName!=null?userName:"unname")+"!");
